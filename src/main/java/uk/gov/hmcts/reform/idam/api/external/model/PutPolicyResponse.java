...
public class PutPolicyResponse   {
  ...
  public PutPolicyResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public PutPolicyResponse active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public PutPolicyResponse description(String description) {
  ...
  **/
  ...
  public PutPolicyResponse applicationName(String applicationName) {
  ...
  **/
  ...
  public PutPolicyResponse actionValues(ActionMap actionValues) {
  ...
  **/
  ...
  public PutPolicyResponse resources(List<String> resources) {
    this.resources = resources;
    return this;
  }

  public PutPolicyResponse addResourcesItem(String resourcesItem) {
  ...
  **/
  ...
  public PutPolicyResponse subject(SubjectMap subject) {
  ...
  **/
  ...
  public PutPolicyResponse condition(ConditionMap condition) {
  ...
  **/
  ...
  public PutPolicyResponse resourceTypeUuid(String resourceTypeUuid) {
  ...
  **/
  ...
  public PutPolicyResponse resourceAttributes(List<Object> resourceAttributes) {
    this.resourceAttributes = resourceAttributes;
    return this;
  }

  public PutPolicyResponse addResourceAttributesItem(Object resourceAttributesItem) {
  ...
  **/
  ...
  public PutPolicyResponse lastModifiedBy(String lastModifiedBy) {
  ...
  **/
  ...
  public PutPolicyResponse lastModifiedDate(String lastModifiedDate) {
  ...
  **/
  ...
  public PutPolicyResponse createdBy(String createdBy) {
  ...
  **/
  ...
  public PutPolicyResponse creationDate(String creationDate) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, putPolicyResponse.name) &&
        Objects.equals(this.active, putPolicyResponse.active) &&
        Objects.equals(this.description, putPolicyResponse.description) &&
        Objects.equals(this.applicationName, putPolicyResponse.applicationName) &&
        Objects.equals(this.actionValues, putPolicyResponse.actionValues) &&
        Objects.equals(this.resources, putPolicyResponse.resources) &&
        Objects.equals(this.subject, putPolicyResponse.subject) &&
        Objects.equals(this.condition, putPolicyResponse.condition) &&
        Objects.equals(this.resourceTypeUuid, putPolicyResponse.resourceTypeUuid) &&
        Objects.equals(this.resourceAttributes, putPolicyResponse.resourceAttributes) &&
        Objects.equals(this.lastModifiedBy, putPolicyResponse.lastModifiedBy) &&
        Objects.equals(this.lastModifiedDate, putPolicyResponse.lastModifiedDate) &&
        Objects.equals(this.createdBy, putPolicyResponse.createdBy) &&
        Objects.equals(this.creationDate, putPolicyResponse.creationDate);
  }
