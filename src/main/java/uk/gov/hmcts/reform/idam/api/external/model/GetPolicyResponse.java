...
public class GetPolicyResponse   {
  ...
  public GetPolicyResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public GetPolicyResponse active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public GetPolicyResponse applicationName(String applicationName) {
  ...
  **/
  ...
  public GetPolicyResponse actionValues(ActionMap actionValues) {
  ...
  **/
  ...
  public GetPolicyResponse resources(List<String> resources) {
    this.resources = resources;
    return this;
  }

  public GetPolicyResponse addResourcesItem(String resourcesItem) {
  ...
  **/
  ...
  public GetPolicyResponse subject(SubjectMap subject) {
  ...
  **/
  ...
  public GetPolicyResponse condition(ConditionMap condition) {
  ...
  **/
  ...
  public GetPolicyResponse resourceTypeUuid(String resourceTypeUuid) {
  ...
  **/
  ...
  public GetPolicyResponse resourceAttributes(List<Object> resourceAttributes) {
    this.resourceAttributes = resourceAttributes;
    return this;
  }

  public GetPolicyResponse addResourceAttributesItem(Object resourceAttributesItem) {
  ...
  **/
  ...
  public GetPolicyResponse lastModifiedBy(String lastModifiedBy) {
  ...
  **/
  ...
  public GetPolicyResponse lastModifiedDate(String lastModifiedDate) {
  ...
  **/
  ...
  public GetPolicyResponse createdBy(String createdBy) {
  ...
  **/
  ...
  public GetPolicyResponse creationDate(String creationDate) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, getPolicyResponse.name) &&
        Objects.equals(this.active, getPolicyResponse.active) &&
        Objects.equals(this.description, getPolicyResponse.description) &&
        Objects.equals(this.applicationName, getPolicyResponse.applicationName) &&
        Objects.equals(this.actionValues, getPolicyResponse.actionValues) &&
        Objects.equals(this.resources, getPolicyResponse.resources) &&
        Objects.equals(this.subject, getPolicyResponse.subject) &&
        Objects.equals(this.condition, getPolicyResponse.condition) &&
        Objects.equals(this.resourceTypeUuid, getPolicyResponse.resourceTypeUuid) &&
        Objects.equals(this.resourceAttributes, getPolicyResponse.resourceAttributes) &&
        Objects.equals(this.lastModifiedBy, getPolicyResponse.lastModifiedBy) &&
        Objects.equals(this.lastModifiedDate, getPolicyResponse.lastModifiedDate) &&
        Objects.equals(this.createdBy, getPolicyResponse.createdBy) &&
        Objects.equals(this.creationDate, getPolicyResponse.creationDate);
  }
