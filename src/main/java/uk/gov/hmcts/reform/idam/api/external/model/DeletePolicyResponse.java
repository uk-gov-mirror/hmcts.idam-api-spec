...
public class DeletePolicyResponse   {
  ...
  public DeletePolicyResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DeletePolicyResponse active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public DeletePolicyResponse description(String description) {
  ...
  **/
  ...
  public DeletePolicyResponse applicationName(String applicationName) {
  ...
  **/
  ...
  public DeletePolicyResponse actionValues(ActionMap actionValues) {
  ...
  **/
  ...
  public DeletePolicyResponse resources(List<String> resources) {
    this.resources = resources;
    return this;
  }

  public DeletePolicyResponse addResourcesItem(String resourcesItem) {
  ...
  **/
  ...
  public DeletePolicyResponse subject(SubjectMap subject) {
  ...
  **/
  ...
  public DeletePolicyResponse condition(ConditionMap condition) {
  ...
  **/
  ...
  public DeletePolicyResponse resourceTypeUuid(String resourceTypeUuid) {
  ...
  **/
  ...
  public DeletePolicyResponse resourceAttributes(List<Object> resourceAttributes) {
    this.resourceAttributes = resourceAttributes;
    return this;
  }

  public DeletePolicyResponse addResourceAttributesItem(Object resourceAttributesItem) {
  ...
  **/
  ...
  public DeletePolicyResponse lastModifiedBy(String lastModifiedBy) {
  ...
  **/
  ...
  public DeletePolicyResponse lastModifiedDate(String lastModifiedDate) {
  ...
  **/
  ...
  public DeletePolicyResponse createdBy(String createdBy) {
  ...
  **/
  ...
  public DeletePolicyResponse creationDate(String creationDate) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, deletePolicyResponse.name) &&
        Objects.equals(this.active, deletePolicyResponse.active) &&
        Objects.equals(this.description, deletePolicyResponse.description) &&
        Objects.equals(this.applicationName, deletePolicyResponse.applicationName) &&
        Objects.equals(this.actionValues, deletePolicyResponse.actionValues) &&
        Objects.equals(this.resources, deletePolicyResponse.resources) &&
        Objects.equals(this.subject, deletePolicyResponse.subject) &&
        Objects.equals(this.condition, deletePolicyResponse.condition) &&
        Objects.equals(this.resourceTypeUuid, deletePolicyResponse.resourceTypeUuid) &&
        Objects.equals(this.resourceAttributes, deletePolicyResponse.resourceAttributes) &&
        Objects.equals(this.lastModifiedBy, deletePolicyResponse.lastModifiedBy) &&
        Objects.equals(this.lastModifiedDate, deletePolicyResponse.lastModifiedDate) &&
        Objects.equals(this.createdBy, deletePolicyResponse.createdBy) &&
        Objects.equals(this.creationDate, deletePolicyResponse.creationDate);
  }
